...
class ReadScreen extends StatelessWidget {
  ...
  ReadScreen({required this.manga});
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: Stack(
              children: [
                ...
                Image.network(
                  manga.posterUrl, // Use the anime's cover image URL from the 'anime' object
              ...
              child: Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text(
                        'Completed 42 chapters out of 50',
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
                ...
                final episodeName = 'Chapter $episodeNumber';
                final episodeDescription =
                    'Description of Chapter $episodeNumber';
